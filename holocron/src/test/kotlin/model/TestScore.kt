...
class TestScore {
    ...
    fun testSOS() {
        val scores = Score(arrayListOf(round)).generateScores()
        assertEquals(0, scores[0].getSOS())
        assertEquals(0, scores[1].getSOS())
        assertEquals(1, scores[2].getSOS())
        assertEquals(1, scores[3].getSOS())
        assertEquals(3, scores[4].getSOS())
    }
